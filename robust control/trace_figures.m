...
ax.YTick = linspace(min(ylim), max(ylim), 5); ax.YAxis.TickLabelFormat = '%.1f';
...
legend('boxon'), set(legend, 'FontName', font, 'FontSize', fsleg)
legend('Location','best'), ax = gca; ax.YMinorGrid = 'on'; ax.YMinorTick = 'on';
...
legend({'Acceleration', 'Reference'}, 'Interpreter','latex')	
legend('boxon'), set(legend, 'FontName', font, 'FontSize', fsleg)
legend('Location','best'), sgtitle('Joint accelerations', 'fontsize', fsl)
